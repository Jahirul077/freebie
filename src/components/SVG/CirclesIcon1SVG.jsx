...
export default function CirclesIcon1SVG({ active = false }) {
    return (
        ...
        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {active ? (
                ...
                <path d="M25 14.9062C26.3288 19.8098 30.1894 23.6709 35.0928 25C30.1897 26.329 26.329 30.1897 25 35.0928C23.6709 30.1894 19.8098 26.3288 14.9062 25C19.8101 23.6711 23.6711 19.8101 25 14.9062Z" stroke="url(#paint1_linear_9401_47516)" strokeWidth="1.2" />
            )}
            <defs>
